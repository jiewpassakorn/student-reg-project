...
class StudentController extends Controller
{
    ...
    function regis() {
        ...
        ->select('registrations.StudentID','registrations.ClassID','registrations.RegStatus','class_details.Section','course_details.CourseID','course_details.CourseName','course_details.Credit')
        ->get();
