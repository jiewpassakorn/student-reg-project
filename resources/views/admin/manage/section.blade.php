    ...
    <div class="container">
        ...
        <div class="row d-flex">
            ...
            <div class="col-12 mt-2 d-flex justify-content-center">
                <a href="#insertModal"><button class="btn ms-sm-5 mx-2 btn-success" data-bs-toggle="modal" data-bs-target="#insertClassModal">เพิ่มรายละเอียดห้องเรียน</button></a>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-2"><label class="labels">รหัสคลาส</label>
                                ...
                                <input type="text" name="ClassID" class="form-control" placeholder="" value="">
                            </div>
                            ...
                            <div class="col-md-6 mt-2"><label class="labels">กลุ่ม</label>
                                ...
                                <input type="text" name="Section" class="form-control" value="" placeholder="">
                            </div>
                            ...
                            <div class="col-md-6 mt-2"><label class="labels">ภาคการศึกษา</label>
                                ...
                                <input type="text" name="Semester" class="form-control" placeholder="" value="">
                            </div>
