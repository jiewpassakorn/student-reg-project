                ...
                <div class="col-md-12">
                    <form action="{{route('courseManage_add')}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <input name="CourseID" type="text" class="form-control" placeholder="" value=""></div>
                            ...
                            <input name="CourseName" type="text" class="form-control" placeholder="" value=""></div>
                            <div class="col-md-6 mt-2"><label class="labels">หน่วยกิต</label>
                            @error('Credit')<span class="text-danger py-0">({{$message}})</span>@enderror
                            <input name="Credit"type="text" class="form-control" value="" placeholder=""></div>
                        </div>
                        <div class="row">
                            ...
                            <input name="DepartmentID" type="text" class="form-control" placeholder="" value=""></div>
                        </div>
